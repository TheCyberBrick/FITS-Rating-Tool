...
/* stub driver I/O routines */

int stub_open(char *filename, int rwmode, int *driverhandle);
int stub_create(char *filename, int *driverhandle);
int stub_size(int driverhandle, LONGLONG *filesize);
int stub_close(int driverhandle);
int stub_flush(int driverhandle);
int stub_seek(int driverhandle, LONGLONG offset);
int stub_read(int driverhandle, void *buffer, long nbytes);
int stub_write(int driverhandle, void *buffer, long nbytes);
