...
{
    public partial class FileMoverExporterConfiguratorView : ReactiveUserControl<FileMoverExporterConfiguratorViewModel>
    {
        private Window? window;

        public FileMoverExporterConfiguratorView()
        {
        ...
        private async Task ShowOpenFolderDialogAsync(InteractionContext<Unit, string> ctx)
        {
            if (window != null)
            {
                var dir = await new OpenFolderDialog().ShowAsync(window);
